...
class ApiVeilleController extends AbstractController
{
    ...
    public function getTempsVeille() {
        ...
        $veilleNormal !== null ? array_push($data, ["label" => $veilleNormal->getLabel(), "temps" => $veilleNormal->getTemps(), "is_actif" => $veilleNormal->getIsActif()]) : array_push($data, ["error" => "Temps de veille normal non trouvé en base"]);
        $veilleMedia !== null ? array_push($data, ["label" => $veilleMedia->getLabel(), "temps" => $veilleMedia->getTemps(), "is_actif" => $veilleMedia->getIsActif()]) : array_push($data, ["error" => "Temps de veille media non trouvé en base"]);
